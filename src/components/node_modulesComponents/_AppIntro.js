...
const defaulStyles = {
  ...
  viewDoneButton: {
    flexDirection: 'row',
    flex: Platform.OS === 'android' ? 1 : 0.3,
    justifyContent: 'center',
    alignItems: 'center',
    alignSelf: 'center',
    textAlign: 'center',
...
class AppIntro extends Component {
  ...
  onNextBtnClick = (context) => {
    ...
    if (state.dir === 'x') x = Platform.OS === 'ios' ? diff * state.width - state.width : diff * state.width;
    console.log('x', x);
  ...
  renderPagination = (index, total, context) => {
    ...
    return (
      <View style={[this.styles.paginationContainer]}>
          ...
          ? (
            <View style={this.styles.viewSkip}>
              <SkipButton
                ...
                styles={[this.styles, { borderColor: 'transparent' }]}
        ...
        {this.props.showDots
          ? (
            <View style={[this.styles.viewDots, { marginLeft: Platform.OS === 'android' ? 120 : 0 }]}>
          ...
          ? (
            <View style={this.styles.viewDoneButton}>
              <DoneButton
                ...
                styles={this.styles}
                // styles={[this.styles, {paddingHorizontal: 30}]}
    ...
    const pageView = (
      <View style={[this.styles.slide, { backgroundColor }]} showsPagination={false} key={index}>
        <Animated.View style={[this.styles.header, ...AnimatedStyle1.transform]}>
          <FastImage resizeMode={FastImage.resizeMode.contain} style={imgStyle} source={imgSource} />
        </Animated.View>
...
AppIntro.defaultProps = {
  ...
  activeDotColor: '#fff',
  rightTextColor: '#665EFF',
  leftTextColor: '#665EFF',
  pageArray: [],
  onSlideChange: () => {},
  onSkipBtnClick: () => {},
  onDoneBtnClick: () => {},

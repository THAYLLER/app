...
import DoneButtonAndroid from './components/DoneButton.android';
import DoneButtonIos from './components/DoneButton.ios';
...
class AppIntro extends Component {
  constructor(props) {
    ...
    this.styles = StyleSheet.create({...{}, ...defaultStyles, ...props.customStyles});
  ...
  onNextBtnClick = (context) => {
    // console.log({context})
    if (this.isScrolling || this.state.isScrolling || context.state.total < 2) return;
    this.isScrolling = true;
    const state = context.state;
    // console.log({state})
    console.log({loop: context.props.loop})
    ...
    return (
      <View style={[this.styles.paginationContainer]}>
        ...
        <View style={{flex: 1, flexDirection: 'row'}}>
            <View style={this.styles.btnSpacing} />
            ...
            <View style={this.styles.viewSpacing} />
        </View>
        }
        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
            {
              this.props.showSkipButton && index > 0 ?
              <View style={this.styles.viewSkip}>
                <SkipButton
                  {...this.props}
                  {...this.state}
                  isSkipBtnShow={this.props.showSkipButton}
                  styles={this.styles}
                  onSkipBtnClick={() => {console.log('called...');this.onBackBtnClick(context)}}
                />
              </View>
              :
